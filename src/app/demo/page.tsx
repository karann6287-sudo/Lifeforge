    ...
    >
      <section aria-label="Demo quest preview" className="rounded-2xl border bg-card/60 p-5 sm:p-6 shadow-lg">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Fitness · grows STR · Hard difficulty
        </p>
        <p className="mt-3 text-sm font-semibold text-primary" aria-label="Sample reward of 200 aura and 50 credits">
          <span aria-hidden="true">✦</span> 200 AURA · <span aria-hidden="true">◉</span> 50 CREDITS
        </p>
        <div className="mt-2" role="progressbar" aria-valuenow={62} aria-valuemin={0} aria-valuemax={100} aria-label="Sample progress: 62 percent toward next rank">
        ...
        <ol className="mt-5 space-y-2 text-sm">
          ...
          <li className="flex gap-2"><span aria-hidden="true">3️⃣</span> Clear it — AURA, CREDITS, attribute, COMBO, and rank-up arrive together.</li>
        </ol>
      </section>
      ...
      <section aria-label="Try it for real" className="rounded-2xl border border-primary/30 bg-primary/10 p-5 sm:p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Sign up, forge your first Easy Fitness quest, begin it, and clear it to watch
          AURA, CREDITS, STR, and COMBO update for real.
        </p>
